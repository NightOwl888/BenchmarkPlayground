...
namespace BenchmarkPlayground.Crc32
{
    ...
    public class Crc32Algorithm : HashAlgorithm
    {
        ...
        private readonly byte[] returnValue = new byte[4];
        ...
        protected override byte[] HashFinal()
        {
            ...
            if (_isBigEndian)
            {
                returnValue[0] = (byte)(_currentCrc >> 24);
                returnValue[1] = (byte)(_currentCrc >> 16);
                returnValue[2] = (byte)(_currentCrc >> 8);
                returnValue[3] = (byte)_currentCrc;
            }
            else
            {
                returnValue[0] = (byte)_currentCrc;
                returnValue[1] = (byte)(_currentCrc >> 8);
                returnValue[2] = (byte)(_currentCrc >> 16);
                returnValue[3] = (byte)(_currentCrc >> 24);
            }
            return returnValue;
        }
